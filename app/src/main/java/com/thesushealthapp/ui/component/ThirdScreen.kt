...
fun ThirdScreen(navController: NavController) {
    Log.d("ThirdScreen", "ThirdScreen")

    val context = LocalContext.current
    Scaffold(topBar = {
        TopAppBar(
            title = { Text(stringResource(ThesusScreen.Third.title)) },
...
@Composable
private fun BodyContent(navController: NavController, innerPadding: PaddingValues) {
    Column(
        modifier = Modifier
            .fillMaxWidth()
            .fillMaxHeight()
